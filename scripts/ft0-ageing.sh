...
QC_GEN_CONFIG_PATH='json://'`pwd`'/etc/ft0-ageing.json'
QC_FINAL_CONFIG_PATH='consul-json://{{ consul_endpoint }}/o2/components/qc/ANY/any/ft0-ageing-{{ it }}'
...
o2-dpl-raw-proxy -b --session default \
  ...
  | o2-ft0-flp-dpl-workflow -b --session default --disable-root-output --pipeline  ft0-datareader-dpl:$N_PIPELINES --configKeyValues "${DPL_PROCESSING_CONFIG_KEY_VALUES}" \
